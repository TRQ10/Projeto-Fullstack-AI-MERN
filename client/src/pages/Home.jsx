  ...
  return (
    ...
    <body className='overflow-hidden'>
      <section className=' flex flex-col justify-center items-center max-w-full h-auto mx-auto box-border p-5 overflow-hidden'>
        ...
        text-[3.5rem] text-[#fefefe] text-center'>Boas-vindas à dAIsy</h1>
          <p className='mt-2 text-[#e3e0b3] text-[16px] text-center'>Somos uma rede social para criação e compartilhamento de imagens criativas geradas pela DALL-E AI através da galeria do site onde todos podem visualizar suas criações! </p>
        </div>

        <div className='mt-16 flex flex-col justify-center items-center m-0 p-0 w-[60vw] lg:w-[50vw]'>
          <FormField
        ...
        <div className='w-full h-auto flex-row flex-wrap gap-1'>
          {loading ? (
            ...
            <>
              ...
              text-xl mb-3'>
                  Mostrando resultados para <span className='text-[#71e1e1]'>{searchText}</span>
                </h2>
              )}
