...
const App = () => (
  <BrowserRouter>
    <header className="w-full sticky top-0 z-30 flex opacity-80 justify-between items-center bg-white sm:px-8 px-4 py-4 border-b border-b-[#e6ebf4]">
      <Link to="/">
        <img src={logo} alt="logo" className="w-28 object-contain" />
      </Link>

      <div className='flex gap-2.5 item-center'>
      <Link to="/usuario" className="font-inter font-medium bg-[#ff6464] text-white px-4 py-2 rounded-md">Login</Link>
