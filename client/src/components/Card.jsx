...
const Card = ({ _id, name, prompt, photo, profilePicture }) => {
      ...
      <section className="flex flex-col m-0 p-0">
        <div className=" flex flex-col rounded-xl relative group shadow-card hover:shadow-cardhover card">
          <div>
            ...
            >
              <div
                className="bg-transparent w-full overflow-hidden rounded-none h-[100vh] fixed flex items-center justify-center flex-col"
                onClick={fecharModal}
              >
                <div className="flex justify-end w-[80%] md:w-[90%] lg:w-[70%] rounded-t-lg bg-[#222121]">
                  <i
                    class="bx bx-x w-5 text-5xl mr-8 cursor-pointer invert"
                    onClick={fecharModal}
                  ></i>
                </div>
                ...
                <div className="w-[80%] md:w-[90%] lg:w-[70%] flex justify-start items-center bg-[#222121] rounded-b-lg flex-col md:flex-row p-3">
                  <img
                    className="w-[70%] md:w-[60%] rounded-lg"
                    src={photo}
                    alt={prompt}
                  />
                  <div className="w-full flex justify-start flex-col-reverse p-2 lg:p-5 gap-6">
                    <p className="text-white text-[1.5em] lg:text-[1.8em] xl:text-[2.2em] prompt text-center">
                      {prompt}
                    </p>
